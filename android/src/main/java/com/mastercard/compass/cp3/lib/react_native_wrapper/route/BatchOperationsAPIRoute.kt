...
class BatchOperationsAPIRoute(
  ...
  private fun extractedResult(it: BatchOperationResultV1): WritableMap {
    ...
    when (it.operation) {
      ...
      is OperationsV1.ReadProgramSpace -> { resultMap.putString("readProgramSpace", parseJWT((result as ReadProgramSpaceDataResponse).jwt, kernelPublicKey)) }
  ...
  private fun prepareOperationsList(listOfOperations: ReadableMap?): ArrayList<OperationsV1> {
    ...
    listOfOperations!!.toHashMap().forEach {
      if (it.key == "registrationData") {
        ...
        operationList.add(
          OperationsV1.ConsumerDeviceNumber(
            programGUID = requestData.programGUID,
            name = requestData.name
          )
        )
        ...
        operationList.add(
          OperationsV1.UpdateCardProfile(
            rid = requestData.rID,
            programGUID = requestData.programGUID,
            name = requestData.name
          )
        ...
        operationList.add(
          OperationsV1.WriteProgramSpace(
            rId = requestData.rID,
        ...
        operationList.add(
          OperationsV1.CreateFinancialSva(
        ...
        operationList.add(
          OperationsV1.CreateEVoucherSva(
        ...
        operationList.add(
          OperationsV1.WriteApplicationDataRecord(
        ...
        operationList.add(
          OperationsV1.ReadApplicationDataBlob(
            programGUID = requestData.programGUID,
            name = requestData.name
          )
        )
        ...
        operationList.add(
          OperationsV1.WriteApplicationDataBlob(
